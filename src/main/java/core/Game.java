...
import players.president.AggressivePlayer;
import players.president.PragmaticPlayer;
import players.president.ProtectivePlayer;
import players.president.RandomPlayer;
...
//                System.out.println("Game " + i + "/" + nRepetitions);
    ...
    public static void main(String[] args) {
        String gameType = Utils.getArg(args, "game", "President");
        ...
        //players.add(new PragmaticPlayer());
        //players.add(new AggressivePlayer());
        players.add(new RandomPlayer());
        //players.add(new ProtectivePlayer());
        players.add(new PragmaticPlayer());
